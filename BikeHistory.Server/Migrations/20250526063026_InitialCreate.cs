    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BikeFrames", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BikeFrames_AspNetUsers_CurrentOwnerId",
                        column: x => x.CurrentOwnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BikeFrames_BikeTypes_BikeTypeId",
                        column: x => x.BikeTypeId,
                        principalTable: "BikeTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BikeFrames_Brands_BrandId",
                        column: x => x.BrandId,
                        principalTable: "Brands",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BikeFrames_Manufacturers_ManufacturerId",
                        column: x => x.ManufacturerId,
                        principalTable: "Manufacturers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreviousOwnerId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OwnershipRecords_AspNetUsers_NewOwnerId",
                        column: x => x.NewOwnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OwnershipRecords_AspNetUsers_PreviousOwnerId",
                        column: x => x.PreviousOwnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OwnershipRecords_BikeFrames_BikeFrameId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BikeFrames_BikeTypeId",
                table: "BikeFrames",
                column: "BikeTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_BikeFrames_BrandId",
                table: "BikeFrames",
                column: "BrandId");

            migrationBuilder.CreateIndex(
                name: "IX_BikeFrames_CurrentOwnerId",
                table: "BikeFrames",
                column: "CurrentOwnerId");

            migrationBuilder.CreateIndex(
                name: "IX_BikeFrames_FrameNumber",
                table: "BikeFrames",
                column: "FrameNumber",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_BikeFrames_ManufacturerId",
                table: "BikeFrames",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OwnershipRecords_BikeFrameId",
                table: "OwnershipRecords",
                column: "BikeFrameId");

            migrationBuilder.CreateIndex(
                name: "IX_OwnershipRecords_NewOwnerId",
                table: "OwnershipRecords",
                column: "NewOwnerId");

            migrationBuilder.CreateIndex(
                name: "IX_OwnershipRecords_PreviousOwnerId",
                table: "OwnershipRecords",
